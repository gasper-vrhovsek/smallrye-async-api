...
@ChannelItem(
        name = "test/some/queue/path/{testId}",
        description = "Just a test consumer",
        parameters = { @Parameter(name = "testId", description = "a parameter", schema = @Schema(type = SchemaType.STRING)) },
        subscribe = @Operation(
                operationId = "consumeSomeQueueEvent",
                message = @Message(
